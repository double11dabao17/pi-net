...
install() {
	...
	./auto_router.sh uninstall

        mkdir /etc/ppp/peers/
        cp $CONFIG_PATH/etc_ppp/chap-secrets /etc/ppp/
        cp $CONFIG_PATH/etc_ppp/pap-secrets /etc/ppp/
        cp $CONFIG_PATH/etc_ppp/dsl-1 /etc/ppp/peers/
